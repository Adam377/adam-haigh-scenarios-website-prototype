...
const Home = () => {
    return(
        <Fragment>
            <ImageBlock title="New Release!" image={chatMossScreenshot}>Our newest release is on the Chat Moss route set between 2018 and 2019! Click the link below to purchase your copy!</ImageBlock>
